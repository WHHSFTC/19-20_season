...
public class VisionFTCJava extends OpenCvPipeline {
    ...
    public VisionFTCJava(Telemetry tl) {
        this.tl = tl;
        defaultValues = true;
        blocks = null;
    }
    public VisionFTCJava() {
        this(null);
    }

    public VisionFTCJava(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight, Telemetry tl){
        defaultValues = false;
    ...
    public VisionFTCJava(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight){
