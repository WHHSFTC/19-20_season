...
public class VisionFTCLibJava extends OpenCvPipeline {
    ...
    public VisionFTCLibJava(Telemetry tl) {
        this.tl = tl;
        defaultValues = true;
        blocks = null;
        means = new ArrayList();
    ...
    public VisionFTCLibJava() {
        this(null);
    }

    public VisionFTCLibJava(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight, Telemetry tl){
        defaultValues = false;
    ...
    public VisionFTCLibJava(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight){
    ...
    private void setValues(double width, double height) {
        if (blocks == null) {
            ...
            blocks.add(
                    new Rect(new Point(firstStonePosition - (stoneWidth / 2), 0.50 * height - (stoneHeight / 2)),
                    new Point(firstStonePosition + (stoneWidth / 2), 0.50 * height + (stoneHeight / 2)))
            );
            blocks.add(
                    new Rect(new Point(secondStonePosition - (stoneWidth / 2), 0.50 * height - (stoneHeight / 2)),
                    new Point(secondStonePosition + (stoneWidth / 2), 0.50 * height + (stoneHeight / 2)))
            );
            blocks.add(
                    new Rect(new Point(thirdStonePosition - (stoneWidth / 2), 0.50 * height - (stoneHeight / 2)),
