...
class VisionFromWall2(val tl: Telemetry) {
    ...
    var POSITION: VisionFromWall.Position = VisionFromWall.Position.NULL
        private set
    ...
    fun processFrame(input: Mat): Mat {
        ...
        try {
            ...
            var location = VisionFromWall.Position.NULL
            ...
            for (i: Int in 0..2) {
                ...
                location = if (avg.`val`.sum() == 0.0) VisionFromWall.Position.values()[i] else location
            }
