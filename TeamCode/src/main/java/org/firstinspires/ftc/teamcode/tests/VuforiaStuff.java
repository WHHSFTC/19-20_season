    ...
    public skystonePos vuforiascan(boolean saveBitmaps, boolean red) {
        ...
        */
        ...
        if (rgbImage != null) {
            ...
            DebugMess.msg("6133 vuforiascan"
...
*/
        ...
        DebugMess.msg("black/yellow L: " + blackCountL + "/" + yellowCountL);
        DebugMess.msg("black/yellow C: " + blackCountC + "/" + yellowCountC);
        DebugMess.msg("black/yellow R: " + blackCountR + "/" + yellowCountR);
